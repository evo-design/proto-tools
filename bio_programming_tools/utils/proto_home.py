"""
bio_programming_tools/utils/proto_home.py
...
_DOCS_URL = "https://github.com/evo-design/bio-programming-tools/blob/main/notes/model-weights.md"
...
def show_first_run_notice() -> None:
    ...
    title = "bio-programming-tools: first-run setup"
