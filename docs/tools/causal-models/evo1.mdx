...
<Tabs>
  <Tab title="Evo1 Sampling">
  **Key:** `evo1-sample`

  Sample DNA sequences using Evo1 language model
...
<ParamField path="model_name" type="enum" default="evo-1-8k-base">
  Evo1 model checkpoint to use

  Options: `evo-1-8k-base`, `evo-1-131k-base`, `evo-1-8k-crispr`, `evo-1-8k-transposon`
</ParamField>
...
<ParamField path="num_tokens" type="integer" default="100">
  Number of tokens to generate
</ParamField>

<ParamField path="prepend_prompt" type="boolean" default="False">
  Whether to prepend prompt to generated sequence
</ParamField>
...
<ResponseField name="scores" type="array">
  Mean log-probability scores per sequence
</ResponseField>
  </Tab>
  <Tab title="Evo1 Scoring">
  **Key:** `evo1-score`

  Score DNA sequences using Evo1 language model
