...
<ResponseField name="kv_caches" type="array">
  ...
  <Tab title="Evo2 Sampling (In-Process)">
  **Key:** `evo2-sample-in-process`

  Sample DNA sequences using Evo2 language model (in-process mode)
...
<ResponseField name="scores" type="List[SequenceScores]" required>
  ...
  <Tab title="Evo2 Scoring (In-Process)">
  **Key:** `evo2-score-in-process`

  Score DNA sequences using Evo2 language model (in-process mode)
