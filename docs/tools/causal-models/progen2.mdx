...
<Tabs>
  <Tab title="ProGen2 Sampling">
  **Key:** `progen2-sample`

  Sample protein sequences using ProGen2 language model
...
<ParamField path="model_checkpoint" type="enum" default="progen2-large">
  ProGen2 model checkpoint to use

  Options: `progen2-small`, `progen2-medium`, `progen2-oas`, `progen2-large`, `progen2-BFD90`, `progen2-xlarge`
</ParamField>

<ParamField path="temperature" type="number" default="0.2">
  Scales the randomness of sampling.
</ParamField>
...
<ParamField path="top_k" type="integer" default="0">
  Top-k sampling limit. Set to 0 to disable.
</ParamField>

<ParamField path="max_length" type="integer" default="256">
  Maximum total sequence length including prompt.
</ParamField>
...
<ParamField path="strip_special_tokens" type="boolean" default="True">
  Whether to strip start and stop tokens ('1' or '2')
</ParamField>
...
<ResponseField name="logits" type="array">
  Per-position logits for generated tokens. Only present if return_logits=True.
</ResponseField>
  </Tab>
  <Tab title="ProGen2 Scoring">
  **Key:** `progen2-score`

  Score protein sequences using ProGen2 language model
