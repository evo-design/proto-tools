...
description: "`sequence-fetch` retrieves DNA, RNA, protein, and structure data for named targets across NCBI Entrez, UniProt, and PDB. It supports ID-first resolution, name+organism fallback, and strict molecular type checks."
---
...
<ParamField path="strict_type_checks" type="boolean" default="True">
  Reject requests where molecule type conflicts with target (e.g. protein for an ncRNA gene)
</ParamField>

<ParamField path="fail_on_type_mismatch" type="boolean" default="True">
  Treat molecule type mismatches as errors instead of warnings
</ParamField>

<ParamField path="include_sequence_checksums" type="boolean" default="True">
  Include SHA256 checksums per sequence
</ParamField>
...
<ParamField path="user_agent" type="string" default="bio-programming-tools/sequence-fetch-v1">
