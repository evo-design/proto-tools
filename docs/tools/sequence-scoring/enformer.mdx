...
<ResponseField name="prediction" type="List[array]" required>
  Predicted activity matrix with shape [896, num_tracks]
</ResponseField>

<ResponseField name="output_tracks" type="List[integer]" required>
  Track indices extracted from Enformer
</ResponseField>
