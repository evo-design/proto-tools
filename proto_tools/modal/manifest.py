...
APP_BUCKETS: dict[str, list[str]] = {
    ...
    "proto-tools-codonfm": ["CodonFMService"],
    ...
    "proto-tools-primer3": ["Primer3Service"],
...
SERVICE_TO_MODULE: dict[str, str] = {
    ...
    "CodonFMService": "proto_tools.modal.masked_models.codonfm_deployment.codonfm_service",
    ...
    "Primer3Service": "proto_tools.modal.sequence_scoring.primer3_deployment.primer3_service",
