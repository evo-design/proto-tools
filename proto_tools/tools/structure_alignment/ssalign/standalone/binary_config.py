...
# NOTE: no `standalone_helpers` import here — install_binary.py exec_modules this file in the
# PARENT process during setup, before the isolated venv (which provides standalone_helpers) exists.
