...
## Execution Backends
- Modal path (`use_modal_gpu() == True`): routes to `LigandMPNNService`.
...
- `bio_tools/tools/inverse_folding/ligandmpnn/examples/example.ipynb`

## Quick Start (Sampling)
```python
from bio_tools.tools.inverse_folding.ligandmpnn import run_ligandmpnn_sample
