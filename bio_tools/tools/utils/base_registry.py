...
class BaseSpec(BaseModel):
    ...
    def serialize_config_model(self, config_model: Type[BaseModel]) -> Dict[str, Any]:
        ...
        and metadata. This provides a standard format for frontend form generation
        and validation.
...
class BaseRegistry(ABC, Generic[SpecType]):
    ...
    def get_schema(cls, key: str) -> Dict[str, Any]:
        ...
        and descriptions - everything needed to generate a frontend form.
        ...
        Examples:
            ...
            >>> # Frontend uses this to generate form fields:
