...
from bio_tools.entities.structures import BFactorType, Structure, StructureEnsemble
...
def run_bioemu(inputs: BioEmuInput, config: BioEmuConfig) -> BioEmuOutput:
    ...
    if use_modal_gpu():
        ...
        logger.debug("Using Modal for BioEmu conformational sampling")
        service = modal.Cls.from_name("bio-programming", "BioEmuService")
