...
## Execution Modes
- Modal path: calls `BioEmuService`.
- Local path: runs `standalone/inference.py` inside `EnvManager("bioemu")`.

## Quick Start
```python
from bio_tools.tools.structure_prediction.shared_data_models import StructurePredictionComplex
from bio_tools.tools.structure_dynamics.bioemu import (
    BioEmuInput,
    BioEmuConfig,
    run_bioemu,
...
- `bio_tools/tools/structure_dynamics/bioemu/examples/example.ipynb`
