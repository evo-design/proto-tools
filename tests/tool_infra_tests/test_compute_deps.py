...
class TestCompatibilityMatrices:
    """Test that compatibility matrices are correctly formatted."""

    def test_torch_compatibility_entries_valid(self):
    ...
    def test_jax_compatibility_entries_valid(self):
    ...
    def test_cuda13_requires_driver_580(self):
...
# ============================================================================
# Tests for detect_compute_environment
# ============================================================================
class TestDetectComputeEnvironment:
    """Test the main compute environment detection function."""
    ...
    def test_cpu_only(self):
        ...
        # CPU-only should not have driver/cuda version keys
    ...
    def test_old_gpu_driver_535(self):
    ...
    def test_malformed_driver_version(self):
        ...
        # Should fall back to oldest range
        assert env["RECOMMENDED_TORCH_SPEC"] == "torch>=2.1,<2.4"
        assert env["RECOMMENDED_JAX_SPEC"] == "jax[cuda12]>=0.4.20,<1"

    def test_malformed_cuda_version(self):
        ...
        # CUDA version should default to 12
        assert env["DETECTED_CUDA_VERSION"] == "12"
        assert "cuda12" in env["RECOMMENDED_JAX_SPEC"]
        assert env["RECOMMENDED_JAX_VARIANT"] == "cuda12"

    def test_missing_driver_version(self):
    ...
    def test_missing_cuda_version(self):
