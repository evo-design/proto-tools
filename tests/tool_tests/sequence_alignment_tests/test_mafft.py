"""Tests for MAFFT tool in bio_programming.tools.sequence_alignment.mafft"""

import pytest

from bio_programming.tools.sequence_alignment.mafft import (
    MafftConfig,
    MafftInput,
    MafftOutput,
    run_mafft_align,
)
from bio_programming.tools.sequence_alignment.msas import MSA
